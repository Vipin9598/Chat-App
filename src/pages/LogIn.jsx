  ...
  return (
    <div className="sm:w-9/12 w-11/12 min-h-screen mx-auto my-auto flex flex-col justify-center items-center">
      ...
      <form
        ...
        className="lg:w-[50%] sm:w-[80%] w-full h-auto  flex flex-col gap-5 relative"
      >
        ...
        <button
          disabled={loading}
          className="text-white bg-yellow-300 rounded-full mt-3 py-1"
          type="submit"
        >
          Sign In
        </button>
        ...
        <div>
          <button
            disabled={loading}
            className="absolute bottom-[-20%] sm:right-[12rem] right-[9rem] sm:text-lg  underline "
          ...
          <button
            disabled={loading}
            className="absolute bottom-[-20%] right-2  underline sm:text-lg"
