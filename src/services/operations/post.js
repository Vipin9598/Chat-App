...
import {createPost_API,deletePost_API,addComment_API,deleteComment_API,likePost_API,fetchAllPost_API} from "../apis"
...
export const deletePost = async(data,dispatch,chatToken) => {
    const result=null;
    dispatch(setLoading(true))
    const toastId = toast.loading("Loading...")
    try{
        result = await apiConnector("POST",deletePost_API,data,{
            Authorization: `Bearer ${chatToken}`
        })
...
export const likePost = async(postId,dispatch,chatToken) => {
    ...
    // const toastId = toast.loading("Loading...")
    try{
        result = await apiConnector("POST",likePost_API,{postId},{
            Authorization: `Bearer ${chatToken}`
        })
